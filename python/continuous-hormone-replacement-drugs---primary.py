...
codes = [{"code":"7559001","system":"gprdproduct"},{"code":"11679001","system":"gprdproduct"},{"code":"11110001","system":"gprdproduct"},{"code":"8137001","system":"gprdproduct"},{"code":"9354001","system":"gprdproduct"}];
REQUIRED_CODES = 1;
